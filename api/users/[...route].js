...
const handler = (req, res) => {
  console.log('Users route handler called:', req.method, req.url);
  
  // For Vercel serverless functions, we need to rewrite the URL
  // The original URL will be like /api/users/profile
  ...
  if (req.query && req.query.route) {
    ...
    console.log('Rewriting URL from', req.url, 'to', '/users' + routePath);
    req.url = '/users' + routePath;
  }
